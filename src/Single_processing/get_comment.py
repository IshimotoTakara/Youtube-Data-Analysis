'''
ビデオIDに対応する動画のコメントをCSVファイルに保存するプログラム
...
def main(comment_list_dir, exe_num, api_key, video_id):
    out_dir = comment_list_dir + "/each"
...
if __name__ == '__main__':
    ...
    main(comment_list_dir, exe_num, api_key, video_id)
